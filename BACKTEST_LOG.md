...
| VP4 | VP2y rule against the **previous RTH day's** value area (Profile session 0930-1600, v2.1), MNQ | 71 | −934 | PF 0.80, DD −2,102, years +184 / −1,175 / +57, 16 time exits. Same mechanics, different reference profile, edge gone. **The edge is specific to the overnight (Asia+London) value area at the NY open** → rejected; ES not run |
